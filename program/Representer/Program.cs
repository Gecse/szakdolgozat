...
namespace Representer
{
    class Program
    {
        ...
        {
            var exerciseFilePath = @"..\Representer.Exercise\RepresenterExercise.cs";
            var representationFile = @"..\Representer.Exercise\representation.txt";
            ...
            var representationText = representation.NormalizeWhitespace().ToFullString();

            File.WriteAllText(representationFile, representationText);
            
            Console.WriteLine(representationText);
        }
    }
